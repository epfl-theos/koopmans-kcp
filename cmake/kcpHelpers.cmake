    ...
    foreach(tgt IN LISTS targets)
        ...
        if(NOT ${tgt_type} STREQUAL "INTERFACE_LIBRARY")
            ...
            target_include_directories(${tgt}
                ...
                INTERFACE
                    $<INSTALL_INTERFACE:${CMAKE_INSTALL_INCLUDEDIR}/koopmans-kcp/${TGT}>)
        endif()
    endforeach()
...
function(qe_install_targets TGT)
    ...
    install(TARGETS ${targets}
        ...
        PUBLIC_HEADER DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/koopmans-kcp/${TGT})
        ...
        if(NOT ${tgt_type} STREQUAL "INTERFACE_LIBRARY")
            ...
            if(tgt_module_dir)
                install(DIRECTORY ${tgt_module_dir}/
                    DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/koopmans-kcp/${TGT})
            endif()
        endif()        
    endforeach()
